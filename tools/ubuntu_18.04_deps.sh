...
apt install curl autoconf pkg-config build-essential libtool libtool-bin virtualenv python3-{pip,yaml} ninja-build clang llvm-dev git swig unzip cmake -yqq
