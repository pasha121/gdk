...
GDK_DEFINE_C_FUNCTION_3(GA_sign_psbt, struct GA_session*, session, const GA_json*, details, struct GA_auth_handler**,
    call, { *call = make_call(new ga::sdk::sign_psbt_call(*session, *json_cast(details))); })
