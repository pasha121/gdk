...
GDK_DEFINE_C_FUNCTION_3(GA_validate_address, struct GA_session*, session, const GA_json*, details,
    struct GA_auth_handler**, call,
    { *call = make_call(new ga::sdk::validate_address_call(*session, *json_cast(details))); });
