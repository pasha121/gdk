...
// TODO: use designated initializers when C++20
const ga::sdk::networks::network_config localtest {
    /*.address_explorer_url =*/ std::string(),
    /*.asset_registry_onion_url =*/ std::string(),
    /*.asset_registry_url =*/ std::string(),
    /*.bech32_prefix =*/ "bcrt",
    ...
    /*.spv_multi =*/ false,
    /*. spv_servers =*/ std::vector<std::string>(),
    /*.spv_enabled =*/ false,
    /*.tx_explorer_url =*/ std::string(),
    /*.wamp_cert_pins =*/ std::vector<std::string>(),
...
const ga::sdk::networks::network_config liquid {
...
const ga::sdk::networks::network_config localtest_liquid {
    /*.address_explorer_url =*/ std::string(),
    /*.asset_registry_onion_url =*/ "http://lhquhzzpzg5tyymcqep24fynpzzqqg3m3rlh7ascnw5cpqsro35bfxyd.onion",
    /*.asset_registry_url =*/ "https://assets.blockstream.info",
    /*.bech32_prefix =*/ "ert",
...
const ga::sdk::networks::network_config testnet_liquid {
...
const ga::sdk::networks::network_config mainnet {
...
const ga::sdk::networks::network_config testnet {
...
const ga::sdk::networks::network_config electrum_liquid{
    /*.address_explorer_url =*/ "https://blockstream.info/liquid/address/",
    /*.asset_registry_onion_url =*/ "http://lhquhzzpzg5tyymcqep24fynpzzqqg3m3rlh7ascnw5cpqsro35bfxyd.onion",
    /*.asset_registry_url =*/ "https://assets.blockstream.info",
    /*.bech32_prefix =*/ "ex",
...
const ga::sdk::networks::network_config electrum_localtest_liquid {
    /*.address_explorer_url =*/ std::string(),
    /*.asset_registry_onion_url =*/ "http://lhquhzzpzg5tyymcqep24fynpzzqqg3m3rlh7ascnw5cpqsro35bfxyd.onion",
    /*.asset_registry_url =*/ "https://assets.blockstream.info",
    /*.bech32_prefix =*/ "ert",
...
const ga::sdk::networks::network_config electrum_mainnet{
    /*.address_explorer_url =*/ "https://blockstream.info/address/",
    /*.asset_registry_onion_url =*/ std::string(),
    /*.asset_registry_url =*/ std::string(),
    /*.bech32_prefix =*/ "bc",
...
const ga::sdk::networks::network_config electrum_testnet {
    /*.address_explorer_url =*/ "https://blockstream.info/testnet/address/",
    /*.asset_registry_onion_url =*/ std::string(),
    /*.asset_registry_url =*/ std::string(),
    /*.bech32_prefix =*/ "tb",
...
const ga::sdk::networks::network_config electrum_localtest {
...
const ga::sdk::networks::network_config electrum_testnet_liquid {
...
const ga::sdk::networks::network_config greenlight_mainnet {
    /*.address_explorer_url =*/ "https://blockstream.info/address/",
    /*.asset_registry_onion_url =*/ std::string(),
    /*.asset_registry_url =*/ std::string(),
    /*.bech32_prefix =*/ "bc",
...
const ga::sdk::networks::network_config greenlight_testnet {
    /*.address_explorer_url =*/ "https://blockstream.info/testnet/address/",
    /*.asset_registry_onion_url =*/ std::string(),
    /*.asset_registry_url =*/ std::string(),
    /*.bech32_prefix =*/ "tb",
...
const ga::sdk::networks::network_config greenlight_localtest {
    /*.address_explorer_url =*/ "http://127.0.0.1:8080/address/",
    /*.asset_registry_onion_url =*/ std::string(),
    /*.asset_registry_url =*/ std::string(),
    /*.bech32_prefix =*/ "bcrt",
...
static std::map<std::string, ga::sdk::networks::network_config> registered_networks = {
    {"localtest", localtest},
    {"liquid", liquid},
    {"localtest-liquid", localtest_liquid},
    {"testnet-liquid", testnet_liquid},
    {"mainnet", mainnet},
    {"testnet", testnet},
    {"electrum-liquid", electrum_liquid},
    {"electrum-localtest-liquid", electrum_localtest_liquid},
    {"electrum-mainnet", electrum_mainnet},
    {"electrum-testnet", electrum_testnet},
    {"electrum-localtest", electrum_localtest},
    {"electrum-testnet-liquid", electrum_testnet_liquid},
    /* {"greenlight-mainnet", greenlight_mainnet}, */
    {"greenlight-testnet", greenlight_testnet},
    {"greenlight-localtest", greenlight_localtest},
};
